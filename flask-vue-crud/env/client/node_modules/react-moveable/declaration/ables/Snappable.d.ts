...
export declare function checkSizeDist(moveable: MoveableManager<any, any>, getNextPoses: (widthOffset: number, heightOffset: number) => number[][], matrix: number[], width: number, height: number, direction: number[], snapDirection: number[], fixedPos: number[], isRequest: boolean, is3d: boolean, datas: any): number[];
...
export declare function checkSnapScale(moveable: MoveableManager<ScalableProps, any>, scale: number[], direction: number[], snapDirection: number[], fixedPos: number[], isRequest: boolean, datas: any): number[];
